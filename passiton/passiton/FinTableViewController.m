...
#import "FinTableViewController.h"
#import "CoreData/CoreData.h"
#import "FinViewController.h"
@interface FinTableViewController ()
@property (nonatomic, strong) NSManagedObjectContext *managedObjectContext;
@property (nonatomic, strong) NSMutableArray *names;
@property (nonatomic, strong) NSMutableArray *fetch;
@end

@implementation FinTableViewController
...
- (void)viewDidLoad {
    ...
    {
        if([[info valueForKey:@"key"] isEqualToString:@"YES"])
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FinViewController *e = [self.storyboard instantiateViewControllerWithIdentifier:@"finance"];
